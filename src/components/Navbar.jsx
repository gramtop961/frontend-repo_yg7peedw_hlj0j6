...
function Navbar() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/50 border-b border-white/40">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-md bg-gradient-to-br from-fuchsia-400 to-indigo-400" />
          <span className="text-sm font-semibold tracking-wide text-slate-900">LUMISKIN</span>
        </a>

        <nav className="hidden md:flex items-center gap-8 text-slate-700">
          <a href="#benefits" className="hover:text-slate-900 transition-colors">Benefits</a>
          <a href="#science" className="hover:text-slate-900 transition-colors">Science</a>
          <a href="#ritual" className="hover:text-slate-900 transition-colors">Ritual</a>
