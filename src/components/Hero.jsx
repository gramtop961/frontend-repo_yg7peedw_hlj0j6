...
function Hero() {
  ...
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden bg-gradient-to-b from-indigo-50 via-fuchsia-50 to-white">
      ...
      <div className="relative z-10 flex min-h-[100svh] items-center">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-white/70 px-3 py-1 text-xs text-slate-600 ring-1 ring-slate-200 shadow-sm">
              <span className="h-1.5 w-1.5 rounded-full bg-fuchsia-400" />Powered by clean science
            </div>
            ...
            <div className="mt-8 flex items-center gap-4">
              ...
              <a href="#science" className="inline-flex items-center justify-center rounded-full bg-white/90 px-6 py-3 text-slate-900 text-sm font-medium shadow ring-1 ring-slate-200 hover:bg-white transition-colors">Learn more</a>
            </div>
          </div>
